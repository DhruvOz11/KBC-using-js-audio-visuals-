...
const audio = document.getElementById('qa6');
...
function redirectToNextPage() {
    setTimeout(function () {
        window.location.href = "7.html"; // Replace "next_page.html" with the URL of your next page
    }, 4000); // 4 seconds delay
}
function redirectToLostPage() {
    setTimeout(function () {
        window.location.href = "4l.html"; // Replace "next_page.html" with the URL of your next page
