...
const audio = document.getElementById('qa8');
...
function redirectToNextPage() {
    setTimeout(function () {
        window.location.href = "9.html"; // Replace "next_page.html" with the URL of your next page
    }, 4000); // 4 seconds delay
}
function redirectToLostPage() {
    setTimeout(function () {
        window.location.href = "25l.html"; // Replace "next_page.html" with the URL of your next page
