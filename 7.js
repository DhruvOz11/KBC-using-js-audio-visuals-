...
const audio = document.getElementById('qa7');
...
function redirectToNextPage() {
    setTimeout(function () {
        window.location.href = "8.html"; // Replace "next_page.html" with the URL of your next page
    }, 4000); // 4 seconds delay
}
function redirectToLostPage() {
    setTimeout(function () {
        window.location.href = "12l.html"; // Replace "next_page.html" with the URL of your next page
