...
const audio = document.getElementById('qa10');
...
document.getElementById('lifeline3').onclick = function(){
    ...
    if (lifeline1Used) {
        ...
        document.getElementById('ans').innerHTML = "Answer is: D";
...
document.getElementById('lifeline1').onclick = function(){
    ...
    if (lifeline1Used) {
        ...
        const element1 = document.getElementById('op1');
...
function redirectToNextPage() {
    setTimeout(function () {
        window.location.href = "uwin.html"; // Replace "next_page.html" with the URL of your next page
    }, 4000); // 4 seconds delay
}
function redirectToLostPage() {
    setTimeout(function () {
        window.location.href = "50l.html"; // Replace "next_page.html" with the URL of your next page
